...
type IssueTokenRequest struct {
	...
	// version, see ADR-015.
	//
	// Deprecated: Marked as deprecated in token_engine.proto.
...
const file_token_engine_proto_rawDesc = "" +
	"\n" +
	"\x12token_engine.proto\x12\btoken.v1\"\x89\x02\n" +
	"\x11IssueTokenRequest\x12\x10\n" +
	"\x03sub\x18\x01 \x01(\tR\x03sub\x12\x1b\n" +
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\x12+\n" +
	"\x0fidempotency_key\x18\x03 \x01(\tB\x02\x18\x01R\x0eidempotencyKey\x12?\n" +
	...
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\x12+\n" +
	"\x0fidempotency_key\x18\x03 \x01(\tB\x02\x18\x01R\x0eidempotencyKey\x12A\n" +
